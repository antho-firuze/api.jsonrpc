...
class Pending_subscription_model extends CI_Model
{
	function __construct() {
		...
		function transaction_search($request)
		{
			...
			if (isset($request->params->fields) && !empty($request->params->fields))
				...
				$this->db->select('simpiID, TrxID, PortfolioID, TrxLinkType, TrxLinkID, TrxDate, 
													TrxDescription, TrxDebit, TrxCredit, TrxSourceID, TrxSource2ID');
			$this->db->from('afa_pending_subscription_transaction');
