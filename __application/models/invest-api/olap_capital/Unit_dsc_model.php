...
class Unit_dsc_model extends CI_Model
{
	...
	function load($request)
	{
		...
		if (isset($request->params->fields) && !empty($request->params->fields))
			...
			$this->db->select('simpiID, PortfolioID, ClientID, PositionDate, AcqNo, TreePrefix, AcqDate, AcqUnit, AcqPrice, AcqTotal');
		$this->db->from('ata_balance_dsc');
