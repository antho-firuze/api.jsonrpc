...
class Portfolio_benchmark_model extends CI_Model
{
	...
	private function _sql($request)
	{
		...
		if (isset($request->params->fields) && !empty($request->params->fields)) 
			...
			$this->db->select('simpiID, PortfolioID, CcyID, PositionDate, FlagDate, BenchmarkValue, BenchmarkAdjustment, WealthRatio, 
					GeometricIndex, r1D, rMTD, r30D, r1Mo, r3Mo, r6Mo, rYTD, r1Y, r2Y, r3Y, r5Y, r10Y, rInception, rQ1, 
					rQ2, rQ2, rQ3, rQ4, rM1, rM2, rM3, rM4, rM5, rM6, rM7, rM8, rM9, rM10, rM11, rM12');
