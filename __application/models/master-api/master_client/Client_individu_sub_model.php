...
class Client_individu_sub_model extends CI_Model
{
	...
	private function _sql($request)
	{
		if (isset($request->params->fields) && !empty($request->params->fields)) 
		   $this->db->select($request->params->fields);
			...
			$this->db->select('T1.simpiID, T1.ClientID, T1.ClientCode, T1.SID, T1.IFUA, T1.ReferralCode, T1.ClientName, 
					 ...
					 T3.ParentID, T4.ClientCode As ParentCode, T4.ClientName As ParentName, T3.SubSeparator, T3.SubName, T3.IsSeparateAccount,  
					 T5.NameFirst, T5.NameMiddle, T5.NameLast, T5.TitleFirst, T5.TitleLast, T5.BirthPlace, T5.BirthDate, 
		...
		$this->db->join('master_client_individu_sub T3', 'T1.simpiID = T2.simpiID And T1.ClientID = T3.ClientID');  
		$this->db->join('master_client T4', 'T3.simpiID = T4.simpiID And T3.ParentID = T4.ClientID');  
		$this->db->join('master_client_individu T5', 'T4.simpiID = T5.simpiID And T4.ClientID = T5.ClientID');  
