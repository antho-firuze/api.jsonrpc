<?php 
namespace formulir_opening_account;
		...
		$htmlDua = '	
					...
					<table border="0" style="width:100%; margin-left:30px;">
										...
										<tr>
												...
												<td valign="bottom" style="border-bottom:0.5pt solid black; font-size:11px;">'.$var->MotherMaidenName.'</td>
										</tr>
						<tr>
